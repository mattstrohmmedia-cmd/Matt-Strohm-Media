      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            aria-modal="true"
          >
            <div className="flex-1 flex flex-col justify-center px-8 lg:px-24 pt-24 pb-12">
            ...
            <div className="absolute bottom-12 left-8 lg:left-24 text-xs text-text-muted tracking-wide">
