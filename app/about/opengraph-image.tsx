...
export const alt = 'About Matt Strohm — Matt Strohm Media';
  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', overflow: 'hidden' }}>
        {/* Photo on right side */}
        <img src={imgBase64} style={{ position: 'absolute', right: 0, top: 0, width: '50%', height: '100%', objectFit: 'cover', objectPosition: 'center top' }} />
        {/* Gradient from left covering photo */}
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(90deg, rgba(5,5,5,1) 0%, rgba(5,5,5,0.97) 45%, rgba(5,5,5,0.6) 70%, rgba(5,5,5,0.1) 100%)', display: 'flex' }} />
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '56px 80px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{ fontSize: 13, letterSpacing: 6, textTransform: 'uppercase', color: '#5a5550', fontFamily: 'sans-serif' }}>About</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              <span style={{ fontSize: 88, lineHeight: 1, color: '#eae6df', fontFamily: 'Instrument Serif', fontWeight: 400 }}>Matthew</span>
              <span style={{ fontSize: 88, lineHeight: 1, color: '#c9a84c', fontFamily: 'Instrument Serif', fontStyle: 'italic', fontWeight: 400 }}>Strohm</span>
            </div>
            <div style={{ fontSize: 18, color: '#6a6560', fontFamily: 'sans-serif', marginTop: 8 }}>
              Photographer &amp; creative director, Aberdeenshire
            </div>
          </div>
