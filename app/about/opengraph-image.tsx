      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '56px 80px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: 13, letterSpacing: 6, textTransform: 'uppercase', color: '#6a6560', fontFamily: 'sans-serif', fontWeight: 700, marginBottom: 16 }}>About</div>
            <span style={{ fontSize: 88, lineHeight: 1, color: '#ffffff', fontFamily: 'Instrument Serif', fontWeight: 400 }}>Matthew</span>
            <span style={{ fontSize: 88, lineHeight: 1, color: '#c9a84c', fontFamily: 'Instrument Serif', fontStyle: 'italic', fontWeight: 400 }}>Strohm.</span>
            <div style={{ fontSize: 17, color: '#8a8580', fontFamily: 'sans-serif', fontWeight: 600, marginTop: 20 }}>Photographer &amp; creative director, Aberdeenshire</div>
          </div>
