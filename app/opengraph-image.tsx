  ...
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', overflow: 'hidden' }}>
        {/* Photo right half */}
        <img src={imgBase64} style={{ position: 'absolute', right: 0, top: 0, width: '52%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '56px 80px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontSize: 13, letterSpacing: 6, textTransform: 'uppercase', color: '#5a5550', fontFamily: 'sans-serif', marginBottom: 16 }}>Aberdeen &amp; Aberdeenshire</div>
            <span style={{ fontSize: 90, lineHeight: 1, color: '#eae6df', fontFamily: 'Instrument Serif', fontWeight: 400 }}>Creative</span>
            <span style={{ fontSize: 90, lineHeight: 1, color: '#c9a84c', fontFamily: 'Instrument Serif', fontStyle: 'italic', fontWeight: 400 }}>media.</span>
            <div style={{ fontSize: 17, color: '#6a6560', fontFamily: 'sans-serif', marginTop: 20 }}>Photography · Video · Web · Social · AI</div>
          </div>
