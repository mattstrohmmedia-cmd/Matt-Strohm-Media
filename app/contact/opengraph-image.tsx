      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '56px 80px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <span style={{ fontSize: 86, lineHeight: 1, color: '#eae6df', fontFamily: 'Instrument Serif', fontWeight: 400 }}>Book a free</span>
            <span style={{ fontSize: 86, lineHeight: 1, color: '#c9a84c', fontFamily: 'Instrument Serif', fontStyle: 'italic', fontWeight: 400 }}>consultation.</span>
            <div style={{ fontSize: 18, color: '#6a6560', fontFamily: 'sans-serif', marginTop: 20 }}>
              No pitch, no hard sell — just an honest conversation.
            </div>
          </div>
